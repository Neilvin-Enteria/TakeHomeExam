          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td class="text-center">
                    <a href="{{route('subagents.edit', $subagents->SubAgentID)}}" class="btn btn-primary btn-sm" style="width:30%; margin-left:auto; margin-right:auto; margin-top: 0; padding-left:5px;">Reassign</a>
