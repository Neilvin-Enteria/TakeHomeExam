            ...
            <div class="inputs-container">
                    <div class="form-group select-agent">
                        <select class="form-select" aria-label="select example" name="Assigned_AgentID">
                            <option hidden>Assign to Agent</option>
                    ...
                    <div class="form-group first-name">
                        ...
                        <input type="text" class="form-control" name="SubAgentFName" id="AgentFName">
                        <p class="error" id="fname-error"></p>
                    </div>
                    <div class="form-group last-name">
                        <label for="AgentLName">Last Name</label>
                        <input type="text" class="form-control" name="SubAgentLName" id="AgentLName">
